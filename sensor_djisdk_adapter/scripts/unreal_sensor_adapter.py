...
if __name__ == "__main__":
    ...
    rospy.Subscriber("/sim_drone/pose",PoseStamped,handle_pose)
    rospy.Subscriber("/sim_drone/twist",TwistStamped,handle_twist)
    rospy.Subscriber("/sim_drone/accel",PointStamped,handle_acc)
    rospy.Timer(rospy.Duration(0.01),update_odom)
    rospy.loginfo("UNREAL SENSOR ADAPTER READY")
